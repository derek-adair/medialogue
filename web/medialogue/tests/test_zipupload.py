...
class AlbumUploadTest(TestCase):
    ...
    def test_get(self):
        ...
        response = self.client.get('/admin/medialogue/photo/upload_zip/')
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'admin/medialogue/photo/upload_zip.html')
    ...
    def test_breadcrumbs(self):
        ...
        self.assertContains(
            ...
            <a href="/admin/medialogue/">Photologue</a> &rsaquo; Photos &rsaquo; Upload </div>""", html=True)
    ...
    def test_missing_fields(self):
        ...
        response = self.client.post('/admin/medialogue/photo/upload_zip/', test_data)
        self.assertEqual(response.status_code, 200)
    ...
    def test_good_data(self):
        ...
        if VERSION[0] == 1 and VERSION[1] <= 8:
            location = 'http://testserver/admin/medialogue/photo/'
        else:
            location = '..'
        ...
        gallery = Album.objects.get(title='This is a test title')
    ...
    def test_existing_gallery(self):
        ...
        existing_gallery = AlbumFactory(title='Existing')
